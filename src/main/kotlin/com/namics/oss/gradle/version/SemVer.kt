...
data class SemVer(
    ...
    /**
     * Check the version number is release ( no preRelease or buildMetadata.
     * @return true if release version
     */
    fun isRelease(): Boolean = preRelease == null && buildMetadata == null
